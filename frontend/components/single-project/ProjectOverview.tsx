        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-400">
              Generate a plan, review the diagram, then approve to launch the
              deployment console.
            </p>
            {project.plan_status && (
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              <Link href={`/dashboard/project/${project.project_id}/plan`}>
            ...
            >
              <Link href={`/dashboard/project/${project.project_id}/deploy`}>
