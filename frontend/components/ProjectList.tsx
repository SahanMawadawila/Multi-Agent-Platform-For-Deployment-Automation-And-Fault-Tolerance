...
const projects = [
  { id: 1, name: "Frontend Monolith", type: "Monolithic", status: "Live", uptime: "99.98%", icon: <Code size={16} />, color: "text-green-400" },
  { id: 2, name: "Payments Microservice", type: "Microservice", status: "Degraded", uptime: "98.12%", icon: <Server size={16} />, color: "text-yellow-400" },
  { id: 3, name: "Auth API", type: "Microservice", status: "Live", uptime: "100.00%", icon: <Server size={16} />, color: "text-green-400" },
  { id: 4, name: "Marketing Site", type: "Monolithic", status: "Offline", uptime: "0.00%", icon: <Code size={16} />, color: "text-red-400" },
];
