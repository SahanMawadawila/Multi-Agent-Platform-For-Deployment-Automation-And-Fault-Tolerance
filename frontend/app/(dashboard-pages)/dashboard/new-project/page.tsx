...
import { Plus, GitBranch, CheckCircle, Zap } from "lucide-react";
...
export const metadata = {
  ...
  description:
    "Start a new project with ToolX's intelligent agents. Follow our simple 3-step guide to deploy your application effortlessly.",
};
